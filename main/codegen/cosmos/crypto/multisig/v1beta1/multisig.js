...
var CompactBitArray = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      extraBitsStored: (0, _helpers.isSet)(object.extraBitsStored) ? Number(object.extraBitsStored) : 0,
      elems: (0, _helpers.isSet)(object.elems) ? (0, _helpers.bytesFromBase64)(object.elems) : new Uint8Array()
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.extraBitsStored !== undefined && (obj.extraBitsStored = Math.round(message.extraBitsStored));
    message.elems !== undefined && (obj.elems = (0, _helpers.base64FromBytes)(message.elems !== undefined ? message.elems : new Uint8Array()));
    return obj;
  },
  fromPartial: function fromPartial(object) {
