...
var LegacyAminoPubKey = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      threshold: (0, _helpers.isSet)(object.threshold) ? Number(object.threshold) : 0,
      publicKeys: Array.isArray(object === null || object === void 0 ? void 0 : object.publicKeys) ? object.publicKeys.map(function (e) {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.publicKeys) {
      obj.publicKeys = message.publicKeys.map(function (e) {
