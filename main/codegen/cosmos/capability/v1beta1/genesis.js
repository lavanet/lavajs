...
var GenesisOwners = {
  encode: function encode(message) {
    ...
    if (message.indexOwners !== undefined) {
      _capability.CapabilityOwners.encode(message.indexOwners, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.indexOwners = _capability.CapabilityOwners.decode(reader, reader.uint32());
          break;
        default:
