...
var StakeAuthorization = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      maxTokens: (0, _helpers.isSet)(object.maxTokens) ? _coin.Coin.fromJSON(object.maxTokens) : undefined,
      allowList: (0, _helpers.isSet)(object.allowList) ? StakeAuthorization_Validators.fromJSON(object.allowList) : undefined,
      denyList: (0, _helpers.isSet)(object.denyList) ? StakeAuthorization_Validators.fromJSON(object.denyList) : undefined,
      authorizationType: (0, _helpers.isSet)(object.authorizationType) ? authorizationTypeFromJSON(object.authorizationType) : 0
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.maxTokens !== undefined && (obj.maxTokens = message.maxTokens ? _coin.Coin.toJSON(message.maxTokens) : undefined);
