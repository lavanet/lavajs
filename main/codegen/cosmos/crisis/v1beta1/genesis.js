...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      constantFee: (0, _helpers.isSet)(object.constantFee) ? _coin.Coin.fromJSON(object.constantFee) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.constantFee !== undefined && (obj.constantFee = message.constantFee ? _coin.Coin.toJSON(message.constantFee) : undefined);
    return obj;
  },
