...
var GenesisState = {
  ...
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.subsFS),
      _step;
    try {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.subsTS),
      _step2;
    try {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.subsFS.push(_fixationEntry.RawMessage.decode(reader, reader.uint32()));
          break;
        case 3:
          message.subsTS.push(_fixationEntry.RawMessage.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.subsFS = ((_object$subsFS = object.subsFS) === null || _object$subsFS === void 0 ? void 0 : _object$subsFS.map(function (e) {
      return _fixationEntry.RawMessage.fromPartial(e);
    })) || [];
    message.subsTS = ((_object$subsTS = object.subsTS) === null || _object$subsTS === void 0 ? void 0 : _object$subsTS.map(function (e) {
      return _fixationEntry.RawMessage.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      subsFS: Array.isArray(object === null || object === void 0 ? void 0 : object.subsFS) ? object.subsFS.map(function (e) {
        return _fixationEntry.RawMessage.fromAmino(e);
      }) : [],
      subsTS: Array.isArray(object === null || object === void 0 ? void 0 : object.subsTS) ? object.subsTS.map(function (e) {
        return _fixationEntry.RawMessage.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.subsFS) {
      obj.subsFS = message.subsFS.map(function (e) {
    ...
    if (message.subsTS) {
      obj.subsTS = message.subsTS.map(function (e) {
        return e ? _fixationEntry.RawMessage.toAmino(e) : undefined;
      });
    } else {
      obj.subsTS = [];
