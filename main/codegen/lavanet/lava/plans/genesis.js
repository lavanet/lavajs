...
var GenesisState = {
  ...
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.plansFS),
      _step;
    try {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.plansFS.push(_fixationEntry.RawMessage.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.plansFS = ((_object$plansFS = object.plansFS) === null || _object$plansFS === void 0 ? void 0 : _object$plansFS.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      plansFS: Array.isArray(object === null || object === void 0 ? void 0 : object.plansFS) ? object.plansFS.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.plansFS) {
      obj.plansFS = message.plansFS.map(function (e) {
