...
var LCDQueryClient = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LCDQueryClient, [{
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              endpoint = "lavanet/lava/plans/params";
              _context.next = 4;
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              endpoint = "lavanet/lava/plans/list";
              _context2.next = 4;
              return this.req.get(endpoint);
            case 4:
    ...
    key: "info",
    value: function () {
      var _info = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(params) {
        var endpoint;
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              endpoint = "lavanet/lava/plans/info/".concat(params.planIndex);
              _context3.next = 3;
              return this.req.get(endpoint);
            case 3:
