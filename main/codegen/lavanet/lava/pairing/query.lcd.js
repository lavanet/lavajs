...
var LCDQueryClient = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LCDQueryClient, [{
    ...
    key: "effectivePolicy",
    value: function () {
      var _effectivePolicy = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13(params) {
        var endpoint;
        return _regenerator["default"].wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              endpoint = "lavanet/lava/pairing/effective_policy/".concat(params.consumer, "/").concat(params.specID);
              _context13.next = 3;
              return this.req.get(endpoint);
            case 3:
      ...
      function effectivePolicy(_x9) {
        return _effectivePolicy.apply(this, arguments);
      }
