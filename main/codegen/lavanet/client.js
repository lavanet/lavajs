...
var protoConflictTxRegistry = _interopRequireWildcard(require("../proto/conflict/tx.registry"));
var protoPairingTxRegistry = _interopRequireWildcard(require("../proto/pairing/tx.registry"));
var protoProjectsTxRegistry = _interopRequireWildcard(require("../proto/projects/tx.registry"));
var protoSubscriptionTxRegistry = _interopRequireWildcard(require("../proto/subscription/tx.registry"));
...
var protoConflictTxAmino = _interopRequireWildcard(require("../proto/conflict/tx.amino"));
var protoPairingTxAmino = _interopRequireWildcard(require("../proto/pairing/tx.amino"));
var protoProjectsTxAmino = _interopRequireWildcard(require("../proto/projects/tx.amino"));
var protoSubscriptionTxAmino = _interopRequireWildcard(require("../proto/subscription/tx.amino"));
...
var lavanetAminoConverters = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, conflictTxAmino.AminoConverter), pairingTxAmino.AminoConverter), projectsTxAmino.AminoConverter), protoConflictTxAmino.AminoConverter), protoPairingTxAmino.AminoConverter), protoProjectsTxAmino.AminoConverter), protoSubscriptionTxAmino.AminoConverter), subscriptionTxAmino.AminoConverter);
exports.lavanetAminoConverters = lavanetAminoConverters;
var lavanetProtoRegistry = [].concat((0, _toConsumableArray2["default"])(conflictTxRegistry.registry), (0, _toConsumableArray2["default"])(pairingTxRegistry.registry), (0, _toConsumableArray2["default"])(projectsTxRegistry.registry), (0, _toConsumableArray2["default"])(protoConflictTxRegistry.registry), (0, _toConsumableArray2["default"])(protoPairingTxRegistry.registry), (0, _toConsumableArray2["default"])(protoProjectsTxRegistry.registry), (0, _toConsumableArray2["default"])(protoSubscriptionTxRegistry.registry), (0, _toConsumableArray2["default"])(subscriptionTxRegistry.registry));
