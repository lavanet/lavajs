...
export const lavanetAminoConverters = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, conflictTxAmino.AminoConverter), pairingTxAmino.AminoConverter), projectsTxAmino.AminoConverter), protoConflictTxAmino.AminoConverter), protoPairingTxAmino.AminoConverter), protoProjectsTxAmino.AminoConverter), protoSubscriptionTxAmino.AminoConverter), subscriptionTxAmino.AminoConverter);
export const lavanetProtoRegistry = [...conflictTxRegistry.registry, ...pairingTxRegistry.registry, ...projectsTxRegistry.registry, ...protoConflictTxRegistry.registry, ...protoPairingTxRegistry.registry, ...protoProjectsTxRegistry.registry, ...protoSubscriptionTxRegistry.registry, ...subscriptionTxRegistry.registry];
