...
export const createLCDClient = async ({
  ...
  return {
    lavanet: {
      lava: {
        conflict: new (await import("../proto/conflict/query.lcd")).LCDQueryClient({
          requestClient
        }),
        epochstorage: new (await import("../proto/epochstorage/query.lcd")).LCDQueryClient({
          requestClient
        }),
        pairing: new (await import("../proto/pairing/query.lcd")).LCDQueryClient({
          requestClient
        }),
        plans: new (await import("../proto/plans/query.lcd")).LCDQueryClient({
          requestClient
        }),
        projects: new (await import("../proto/projects/query.lcd")).LCDQueryClient({
          requestClient
        }),
