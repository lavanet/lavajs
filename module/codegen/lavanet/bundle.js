...
(function (_lavanet) {
  ...
  const ClientFactory = _lavanet.ClientFactory = _objectSpread(_objectSpread(_objectSpread({}, _342), _343), _344);
})(lavanet || (lavanet = {}));